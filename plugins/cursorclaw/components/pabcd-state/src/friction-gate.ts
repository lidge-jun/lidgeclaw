    ...
    return `${JSON.stringify({
      hookSpecificOutput: {
        ...
        permissionDecisionReason:
          "[cursorclaw friction] A shell failure has recurred to the stop threshold. Review .codexclaw/friction.jsonl and change approach before re-running the same command.",
      },
    })}\n`;
  } catch {
    return ""; // FAIL-OPEN
