...
TAGS_CACHE_DIR = os.environ.get(
    "CODEXCLAW_REPOMAP_CACHE",
    os.path.join(os.getcwd(), ".codexclaw", "cache", "repomap", f"tags.v{CACHE_VERSION}")
)
...
class RepoMap:
    ...
    def get_tags_raw(self, fname: str, rel_fname: str) -> List[Tag]:
        ...
        try:
            ...
            raise RuntimeError("grep-ast and tree-sitter are required to parse source files") from err
