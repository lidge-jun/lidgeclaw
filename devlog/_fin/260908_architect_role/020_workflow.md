...
MODIFY `plugins/cursorclaw/agents/README.md`: add architect -> explorer, no write, dev/dev-architecture row; explain configured model rather than hardcoded provider, prompt source not installed registration.
