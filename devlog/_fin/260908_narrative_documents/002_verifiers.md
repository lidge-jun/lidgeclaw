...
|---|---|---|
| `node --test plugins/cursorclaw/test/skill-catalog.test.mjs` (worktree) | 0, 4 pass | Reads skills/README.md catalog block, on-disk SKILL.md folders, README badges. Does not read prose. |
| `/usr/local/bin/python3 /Users/jun/.codex/skills/.system/skill-creator/scripts/quick_validate.py plugins/cursorclaw/skills/search` | 0 "Skill is valid!" | Frontmatter of the named skill only |
| same for plugins/cursorclaw/skills/dev-diagram-viewer | 0 | same |
| `node --test --test-concurrency=1 'plugins/cursorclaw/components/pabcd-state/test/*.test.ts' 'plugins/cursorclaw/components/subagent-config/test/*.test.ts' 'plugins/cursorclaw/test/*.test.mjs'` in /tmp/pr84-merge-260908 (origin/dev 50b7309c + pr84 57e63fdc, CHANGELOG resolved) | 0; pass 1857, fail 0, 61.5 s | Reads PR #84's changed src/dist/test files including worktree-source-integration.test.ts and qa-validate-evidence.test.mjs. Log: evidence/wp4/merge-tests-wp1.log |
...
- `cxc receipt test -- node --test plugins/cursorclaw/test/skill-catalog.test.mjs`: 4 pass,
  receipt at .cursorclaw/evidence/<session>/test-receipt.json.
